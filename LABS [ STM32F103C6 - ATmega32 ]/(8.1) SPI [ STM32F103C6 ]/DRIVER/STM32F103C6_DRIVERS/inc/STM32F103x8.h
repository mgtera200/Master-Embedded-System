...
#define NVIC_IRQ35_SPI1_ENABLE					(NVIC->NVIC_ISER1 |= 1<<(SPI1_IRQ - 32))
#define NVIC_IRQ36_SPI2_ENABLE					(NVIC->NVIC_ISER1 |= 1<<(SPI2_IRQ - 32))
...
#define NVIC_IRQ35_SPI1_DISABLE					(NVIC_ICER->NVIC_ICER1 |= 1<<(SPI1_IRQ - 32))
#define NVIC_IRQ36_SPI2_DISABLE					(NVIC_ICER->NVIC_ICER1 |= 1<<(SPI2_IRQ - 32))
