This project i made driver for EXTI module and used it to configure Port B pin number 9 as an external interrupt pinthen we configured it as an falling edge interrupt and used the 
